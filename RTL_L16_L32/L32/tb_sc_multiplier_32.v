...
// Standalone L=32 verification bench. Do NOT use this as a synthesis source.
module tb_sc_multiplier_32;
    ...
    task run_case;
        ...
        begin
            ...
            probability = ones_product/32.0;
            decoded = probability*65025.0;
            $display("L=32 | A=%3d B=%3d | ones A/B/P=%2d/%2d/%2d | SC=%5d exact=%5d err=%5d | pP=%0.4f",
    ...
    initial begin
        ...
        $display("============================================================");
        $display("L=32 STOCHASTIC MULTIPLIER");
        $display("Fixed SNG pair: P2-198 x P2-86 | stream length = 32");
        $display("============================================================");
